...
if(DEFINED Boost_USE_STATIC_LIBS)
  ...
  if(NOT WIN32 AND NOT _BOOST_SINGLE_VARIANT)
    _BOOST_SKIPPED("libboost_prg_exec_monitor-mt-x64.a" "static, default is shared, set Boost_USE_STATIC_LIBS=ON to override")
    return()
  endif()
endif()
...
if(DEFINED Boost_USE_MULTITHREADED AND NOT Boost_USE_MULTITHREADED)
  _BOOST_SKIPPED("libboost_prg_exec_monitor-mt-x64.a" "multithreaded, Boost_USE_MULTITHREADED=${Boost_USE_MULTITHREADED}")
  return()
endif()
...
if(Boost_VERBOSE OR Boost_DEBUG)
  message(STATUS "  [x] libboost_prg_exec_monitor-mt-x64.a")
endif()
...
if(__boost_imploc)
  message(SEND_ERROR "Target Boost::prg_exec_monitor already has an imported location '${__boost_imploc}', which is being overwritten with '${_BOOST_LIBDIR}/libboost_prg_exec_monitor-mt-x64.a'")
endif()
