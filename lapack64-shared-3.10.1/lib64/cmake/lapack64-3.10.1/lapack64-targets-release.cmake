...
set_target_properties(blas64 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libblas64.so.3.10.1"
  IMPORTED_SONAME_RELEASE "libblas64.so.3"
  )

list(APPEND _cmake_import_check_targets blas64 )
list(APPEND _cmake_import_check_files_for_blas64 "${_IMPORT_PREFIX}/lib64/libblas64.so.3.10.1" )
...
set_target_properties(lapack64 PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/liblapack64.so.3.10.1"
  IMPORTED_SONAME_RELEASE "liblapack64.so.3"
  )

list(APPEND _cmake_import_check_targets lapack64 )
list(APPEND _cmake_import_check_files_for_lapack64 "${_IMPORT_PREFIX}/lib64/liblapack64.so.3.10.1" )
